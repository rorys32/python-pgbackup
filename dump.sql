...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: postadmin
--
...
ALTER TABLE public.employees OWNER TO postadmin;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: postadmin
--
